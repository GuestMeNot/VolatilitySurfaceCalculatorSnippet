...
public class BlackScholes {
    ...
    /**
     * This value matches the underlying option data best.
     */
     ...
     * @param dte - The option's Days to Expiration DTE as a percentage of a calendar year (e.g. 30 DTE would be passed in as 30d/365d).
...
//		double ket = X*et;
    ...
    public static double optionPrice(OptionData data, double iv, double r) {
        ...
        return optionPrice(isCallOption, S, X, data.getDte(), r, iv);
    }
    ...
    public static void setOriginalGreeksByOptionPrice(OptionData data, double interestRate) {
        ...
        double iv = impliedVolatility(isCall, asset, strike, dte, interestRate, price);
        double delta = delta(isCall, asset, strike, dte, interestRate, iv);
        double vega = vega(isCall, asset, strike, dte, interestRate, iv);
        double gamma = gamma(isCall, asset, strike, dte, interestRate, iv);
        double theta = theta(isCall, asset, strike, dte, interestRate, iv);

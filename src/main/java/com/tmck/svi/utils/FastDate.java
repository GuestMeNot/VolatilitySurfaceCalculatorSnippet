 ...
 * Joda-Time and newer Java Date code was not accepted when this class was created.
 * 
 * @author tim
 */
public class FastDate extends Date {
	...
	public FastDate() { super(); }
	public FastDate(long date) { super(date); }	
	public FastDate(Date date) { this(date.getTime()); }
	public FastDate(FastDate date) { this(date.getJavaDate()); }
	...
	public Date getJavaDate() { return this; }
	...
	public FastDate copy() { return (FastDate) clone(); }
	...
	public static boolean isLeapSecondCompliant() {
		...
		if(!leapSecondCompliant && !verifyDate.equals(july1)) {
			return false;
		}
		return true;
	}
	...
	public static boolean isDaylightSavingsCompliant() {
		...
		if(!daylightSavingsCompliant && !verifyDate.equals(april4)) {
			return false;
		}
		return true;
	}
    ...
    public synchronized GregorianCalendar convertToCalendar() {
        ...
        if(cal != null) {
            greg = (GregorianCalendar) cal.get();
        }
        if(greg == null) {

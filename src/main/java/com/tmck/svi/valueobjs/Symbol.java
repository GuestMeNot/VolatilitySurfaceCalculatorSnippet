...
public class Symbol implements Comparable<Symbol>, Serializable {
	...
	public Symbol(String symbol, String type) { this(symbol, type, null); }
	...
	public Symbol getRelatedSymbol() { return relatedSymbol; }
	...
	public Symbol [] convertCollectionToArray(Collection<? extends Symbol> c) {
		return (Symbol []) c.toArray(new Symbol[c.size()]);
	}
	...
	public int compareTo(Symbol that) {
		...
		int val = this.getName().compareTo(that.getName());
	...
	public String getRName() {
		...
		String str = StringUtils.substitute(name, "@", "at_");
		str = StringUtils.substitute(str, "^", "hat_");
		str = StringUtils.substitute(str, "!", "bang_");
		str = StringUtils.substitute(str, "(", "_");
		str = StringUtils.substitute(str, ")", "_");
    ...
    /**
     * For Foreign shares there is a '.' instead of a '-'
     * 
     * @return
     */
    public String getYahooName() {
        return StringUtils.substitute(getName(), "-", ".");
    }

    /**
     * For class A and B shares there is a '-' instead of a '.'
     * 
     * @return
     */

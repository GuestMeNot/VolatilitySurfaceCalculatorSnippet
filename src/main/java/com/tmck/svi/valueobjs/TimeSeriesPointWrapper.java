...
public class TimeSeriesPointWrapper extends TimeSeriesPoint implements PointWrapper {
	...
	public void setCombinationStategy(byte combinationStategy) {
		...
		getWrapped().setCombinationStategy(combinationStategy);
	}
	...
	public TimeSeriesPoint getRoot() {
		...
		while (data != null && data instanceof TimeSeriesPointWrapper) {
			prevData = data;
	...
	public TimeSeriesPoint copy() {
		...
		TimeSeriesPointWrapper wrapper = create(dateCopy, value, wrappedCopy);
